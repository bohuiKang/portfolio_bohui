package com.bohui.portfolio.admin.context.skill.controller

import com.bohui.portfolio.admin.context.skill.service.AdminSkillService
...
class AdminSkillViewController(
    ...
    @GetMapping
    fun skill(model: Model): String { // 리턴타입은 String
