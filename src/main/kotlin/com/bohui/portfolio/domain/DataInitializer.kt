package com.bohui.portfolio.domain

import com.bohui.portfolio.domain.constant.SkillType
import com.bohui.portfolio.domain.entity.*
import com.bohui.portfolio.domain.repository.*
    ...
    fun initializerData(){
        ...
        val achievements = mutableListOf<Achievement>(
            ...
            Achievement(
                ...
                host = "한국산업인력공단",
                achievedDate = LocalDate.of(2024, 6, 1),
                isActive = true
            )
        )
